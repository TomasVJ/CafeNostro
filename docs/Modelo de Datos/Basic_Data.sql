...
INSERT INTO `categoria` VALUES (1,'Comida','','Cocina'),(2,'Helado','Selección de helados artesanales de distintos sabores.','Heladeria'),(3,'Bebidas Calietes','Distintos tipos de café hecho por baristas profesionales.','Barra'),(4,'Bebidas Frias','Conjunto de bebidas y/o jugos para acompañar.','Barra'),(5,'Reposteria','','Cocina'),(6,'Otros','','Barra');
